...
<%
    if (request.getParameter("cerca") != null) {
        ...
        if (request.getParameter("numminletti") != "")  {
            filtraggioAnnunciAppartamentiBean.setNum_min_letti(Integer.valueOf(request.getParameter("numminletti")));
        } else  {
            filtraggioAnnunciAppartamentiBean.setNum_min_letti(0);
        }

        if (request.getParameter("nummaxletti") != "")  {
            filtraggioAnnunciAppartamentiBean.setNum_max_letti(Integer.valueOf(request.getParameter("nummaxletti")));
        } else  {
            filtraggioAnnunciAppartamentiBean.setNum_max_letti(0);
        }

        if (request.getParameter("numminstanze") != "")  {
            filtraggioAnnunciAppartamentiBean.setNum_min_stanze(Integer.valueOf(request.getParameter("numminstanze")));
        } else  {
            filtraggioAnnunciAppartamentiBean.setNum_min_stanze(0);
        }

        if (request.getParameter("nummaxstanze") != "")  {
            filtraggioAnnunciAppartamentiBean.setNum_max_stanze(Integer.valueOf(request.getParameter("nummaxstanze")));
        } else  {
            filtraggioAnnunciAppartamentiBean.setNum_max_stanze(0);
        }
        ...
        try {
            if (Date.valueOf(request.getParameter("check-in")).compareTo(Date.valueOf(request.getParameter("check-out")))>0)    {
                %>
                    <script>
                        alert("Inserire data di check-in minore di data di check-out");
                    </script>
                <%
            }else if(request.getParameter("prezzoMin")!="" && request.getParameter("prezzoMax")!="")   {
                if (Double.parseDouble(request.getParameter("prezzoMin"))>Double.parseDouble(request.getParameter("prezzoMax")))    {
                    %>
                        <script>
                            alert("Inserire prezzo minimo minore di prezzo massimo");
                        </script>
                    <%
                }
            }
    ...
    <nav>
        <form>
            ...
            <ul>
                ...
                <h4>
                    Prezzo minimo: <br><input type="text" id="prezzoMin" name="prezzoMin"><br><br>
                ...
                <li>
                    Numero massimo persone: <input type="text" id="nummaxpersone" name="nummaxpersone"><br><br>
                    Numero minimo letti: <input type="text" id="numminletti" name="numminletti"><br><br>
                    Numero massimo letti: <input type="text" id="nummaxletti" name="nummaxletti"><br><br>
                    Numero minimo stanze: <input type="text" id="numminstanze" name="numminstanze"><br><br>
                    Numero massimo stanze: <input type="text" id="nummaxstanze" name="nummaxstanze"><br><br>
                </li>
                <h4>Sesso:<br>
                ...
                <li id="<%=i%>">
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <h3><b><%=lista.get(i).getNome()%></b></h3>
                        </div>
                        <div class="col-sm-9">
                            <h4><br>
                                Luogo: <%=lista.get(i).getLuogo()%> <br>
                                Prezzo: <%=lista.get(i).getPrezzo()%> € <br>
                                Valutazione: <%=lista.get(i).getValutazione()%> stelle
                            </h4>
                        </div>
